...
urlpatterns = [
    ...
    path('bo/password/', user_view.BackOfficeChangePasswordView.as_view(), name='bo_change_password'),
    path('bo/profile/', user_view.BackOfficeProfileView.as_view(), name='profile_bo'),
    path('bo/regis/', user_view.BackOfficeIndexView.as_view(), name='regis_bo'),
    path('bo/edit/', user_view.BackOfficeEditView.as_view(), name='bo_edit'),
