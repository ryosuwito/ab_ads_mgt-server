...
urlpatterns = [
    ...
    path('campaign/', login_required(include('campaign_mgt.urls'))),
    path('driver/', login_required(include('driver_mgt.urls'))),
    path('payment/', login_required(include('payment.urls'))),
    path('vehicle/', login_required(include('vehicle_mgt.urls'))),
